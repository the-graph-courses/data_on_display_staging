...
This is a CODE ALONG document that you can type code into as you follow the lesson video. 

This is to encourage you to type along with the teacher; the best way to learn. 

If you prefer to work with the completed document, please use the the "*_filled" Rmd instead!
```
...
# Scatter plots and smoothing lines with {ggplot2}
