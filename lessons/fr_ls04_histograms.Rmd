...
Un histogramme est un graphique qui visualise la *distribution* d'une variable quantitative comme suit :
...
Nous allons visualiser la distribution des variables quantitatives du dataframe `malidd` que nous avons vu dans les cours précédents.
...
Contrairement aux nuages de points et aux graphiques linéaires, les histogrammes représentent les informations d'une seule variable quantitative. Plus précisément, ils permettent de visualiser la distribution de la variable quantitative en question.
...
Le contenu de ce cours a été adapté des sources suivantes :
