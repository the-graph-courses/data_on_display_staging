...
![Boxplots visualize summary statistics of continuous data.](images/boxplot_anatomy.png){alt="Anatomy of a boxplot" width="757"} ![](images/white_square.jpg)
...
q6 <- ggplot(gapminder, 
  ...
  labs(title = "Variation in GDP per capita across continents (1952-2007)",
       x = "Continent",
       y = "Income per person (USD)") + 
  geom_jitter(width = 0.3, alpha = 0.45)
