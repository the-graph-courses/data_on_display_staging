...
mute(here::here("lessons/ls03_line_autograder.R"))
```

# Lines, scales, and labels in {ggplot2}
...
4)  **`lifeExp`**: Average number of years a newborn child would live if current mortality patterns
...
::: practice
Create a time series plot comparing the trends in GDP per capita from 1952-2007 for **three
...
-   Subtitle: include country names
