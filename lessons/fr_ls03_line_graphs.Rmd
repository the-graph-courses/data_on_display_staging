...
Les graphiques linéaires sont utilisés pour montrer les **relations** entre deux **variables numériques**, tout comme les nuages de points.
Ils sont particulièrement utiles lorsque la variable sur l'axe des x, également appelée variable *explicative*, est de nature **séquentielle**. En d'autres termes, il y a un ordre inhérent à la variable.
...
Ensuite, nous ajouter un titre au-dessus du graphique avec l'argument `title`.
...
-   Ismay, Chester, and Albert Y. Kim. 2022. *A ModernDive into R and
    the Tidyverse*. <https://moderndive.com/>.
-   Kabacoff, Rob. 2020. *Data Visualization with R*.
