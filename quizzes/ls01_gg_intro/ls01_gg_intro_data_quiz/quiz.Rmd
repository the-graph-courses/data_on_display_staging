...
**Next, create a ggplot2 line graph of population over time. Then indicate which of the plots below (from a to f) most closely resembles your output plot. Letter answer: {`r correct_plot_letter`}**
