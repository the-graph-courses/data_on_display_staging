...
point_color <- sample(colors(), 3)


hiv_incidence_pop <- read_csv("data/clean/hiv_incidence_pop.csv")
View(hiv_incidence_pop)

high_hiv_prev_pop %>% ggplot(aes(population, total_cases)) + geom_point()

hiv_prevalence <- read_csv("data/clean/hiv_prevalence.csv")
...
**Next, create a ggplot2 scatterplot with the two calculated variables. Then indicate which of the plots below (from a to f) most closely resembles your output plot. Letter answer: {`r correct_plot_letter`}**
