...
Add `size = 3` inside the `aes()` function.

## B

Add `size = 3` inside the `geom_line()` function.

## C

Add `size = 3` inside the `ggplot()` function, but outside the `aes()` function.
...
Great work! This is an example of *fixing* an aesthetic (in this case, we want to fix the *size* aesthetic of the lines to size `3`).
...
This is an example of *fixing* an aesthetic (in this case, we want to fix the *size* aesthetic of the lines to size `3`).
